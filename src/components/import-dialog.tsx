...
export default function ImportDialog({
  ...
  const templateEndpoint = `/api/import-${type}/template`
      ...
      <div className="space-y-4">
        ...
        {hasErrors && (
          <div className="space-y-2">
            ...
            <ScrollArea className="max-h-[300px] rounded-md border border-slate-200">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-xs text-blue-700">
                      ...
                      It includes sample data and an Instructions sheet with all valid values.
                    </p>
                  </div>
                </div>
                <Button
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-blue-100 bg-blue-50/50 p-3">
                <p className="text-xs text-blue-700">
                  ...
                  Make sure your &quot;Client&quot; column has names that exactly match existing clients in the system.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-0.5 text-[11px]">
                {Object.entries(row.data).map(([key, value]) => {
                  ...
                  const hasError = row.errors.some(
                    (e) => e.column.toLowerCase().replace(/\s/g, '') === key.toLowerCase().replace(/\s/g, '')
                  )
                  return (
                    <div key={key} className="flex items-start gap-1.5">
                      ...
                      <span
                        className={cn(
                          'truncate',
                          hasError ? 'text-red-700 bg-red-50 px-1 rounded' : 'text-slate-700'
                        )}
                      >
                        {value || '—'}
                      </span>
          ...
          <div>
            ...
            <div className="space-y-1.5">
              {row.errors.map((error, idx) => (
                <div
                  key={idx}
                  className="flex items-start gap-2 text-xs bg-white rounded border border-red-100 p-2"
                >
                  ...
                  <div className="space-y-0.5">
                    ...
                    {error.value && error.value !== '(column not found)' && (
                      <p className="text-slate-500">
                        Your value: <code className="bg-slate-100 px-1 rounded text-[11px] font-mono">{error.value}</code>
                      </p>
                    )}
                  </div>
                </div>
